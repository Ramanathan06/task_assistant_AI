...
### Git Author Rules
- **Author name**: Always `Ramanathan06` — never use any other name
...
- Local git config must be: `user.name = Ramanathan06`
...
- Remote: `Ramanathan06/task_assistant_AI`
- Push access requires `Ramanathan06` account (use `gh auth switch --user Ramanathan06` before pushing)
- Default branch: `main`
